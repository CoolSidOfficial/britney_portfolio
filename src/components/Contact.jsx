...
export const Contact = () => {
  return (
    ...
    <div className="text-white text-3xl p-2">
       ...
       <a href="mailto:siddhantjainmvm@gmail.com?subject=Hello" className="text-white border p-5  place-self-center  w-60  rounded   transition-transform duration-300 transform hover:shadow-[7px_9px_0px_rgba(100,255,218,1)] hover:translate-y-[-2px] hover:translate-x-[-2px]  mt-10"> Say Hello!</a>
