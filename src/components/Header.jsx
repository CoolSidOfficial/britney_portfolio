...
const Header = (props) => {
 ...
 <p className=" md:mb-0 mb-20 p-2  md:mt-5 text-lg block md:p-6 md:text-xl font-semibold text-[#8892B0]">{props.description}</p>
 <a href="https://www.linkedin.com/in/siddhant-jain-coolsidofficial/" className="text-white  border md:absolute md:left-[130px] md:m-0 p-6 mx-6 mb-11 md:p-6 rounded transition-transform duration-300 transform hover:shadow-[7px_9px_0px_rgba(100,255,218,1)] hover:translate-y-[-2px] hover:translate-x-[-2px]  md:text-xl"> Check out my Linkedin!</a>
 </header>
 </Fade>
  )
}
